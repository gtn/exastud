...
function xmldb_block_exastud_upgrade($oldversion = 0) {
	...
	if ($oldversion < 2018070600) {
	    ...
	    $table->add_key('bpid', XMLDB_KEY_FOREIGN, array('bpid'), 'block_exastudbp', array('id'));
	    $table->add_key('periodid', XMLDB_KEY_FOREIGN, array('periodid'), 'block_exastudperiod', array('id'));
	    $table = new xmldb_table('block_exastudclassteachers');
	    $table->add_key('teacherid', XMLDB_KEY_FOREIGN, array('teacherid'), 'user', array('id'));
	    $table->add_key('classid', XMLDB_KEY_FOREIGN, array('classid'), 'block_exastudclass', array('id'));
	    $table->add_key('subjectid', XMLDB_KEY_FOREIGN, array('subjectid'), 'block_exastudsubjects', array('id'));
	    ...
	    $table->add_key('classid', XMLDB_KEY_FOREIGN, array('classid'), 'block_exastudclass', array('id'));
	    $table->add_key('categoryid', XMLDB_KEY_FOREIGN, array('categoryid'), 'block_exastudcate', array('id'));
	    $table = new xmldb_table('block_exastudreviewpos');
	    $table->add_key('categoryid', XMLDB_KEY_FOREIGN, array('categoryid'), 'block_exastudcate', array('id'));
	    $table->add_key('reviewid', XMLDB_KEY_FOREIGN, array('reviewid'), 'block_exastudreview', array('id'));
	    $table = new xmldb_table('block_exastudclassteastudvis');
	    $table->add_key('classteacherid', XMLDB_KEY_FOREIGN, array('classteacherid'), 'block_exastudclassteachers', array('id'));
	    $table = new xmldb_table('block_exastuddata');
	    $table->add_key('subjectid', XMLDB_KEY_FOREIGN, array('subjectid'), 'block_exastudsubjects', array('id'));
	    $table->add_key('studentid', XMLDB_KEY_FOREIGN, array('studentid'), 'user', array('id'));
	    upgrade_block_savepoint(true, 2018070600, 'exastud');
	}
