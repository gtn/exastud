...
{
	$content = file_get_contents($language.'/block_exabis_student_review.php');
...
function getTranslations($language)
{
	...
	if (file_exists($language.'/block_exabis_student_review.php')) {
		require ($language.'/block_exabis_student_review.php');
	} else {
		require ($language.'/block_exabis_student_review.orig.php');
	}
...
foreach ($langPaths as $langPath) {
	...
	/*
	if (!file_exists($langPath.'/block_exabis_student_review.php.tmp')) {
		rename($langPath.'/block_exabis_student_review.php', $langPath.'/block_exabis_student_review.php.tmp');
	}
	*/

	file_put_contents($langPath.'/block_exabis_student_review.php', $fileContent);
}
