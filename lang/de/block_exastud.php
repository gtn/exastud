...
$string['periods_incorrect'] = 'Eingabe-Periode nicht korrekt';
...
$string['allow_review_until'] = 'bis';
$string['allow_review_admin_approved'] = 'zustimmen';
$string['allow_review_admin_approved_for_all'] = 'für alle';
$string['allow_review_make_request'] = 'Anfrage an den Administrator um das Bearbeiten freizuschalten';
$string['allow_review_make_request_already'] = 'Die Aktivierungsanfrage wurde bereits an den Administrator weitergeleitet';
$string['admin_requests'] = 'Benutzeranfragen';
$string['admin_requests_class_delete_list'] = 'Klasse löschen';
$string['admin_requests_class_title'] = 'Klasse';
$string['admin_requests_class_teacher'] = 'Klassenlehrkraft';
$string['admin_requests_class_delete'] = 'Löschen';
$string['admin_requests_unlock_review_list'] = 'Aktivieren der Beurteilungsmöglichkeit von Klassen aus vergangenen Eingabezeiträumen';
$string['admin_requests_unlock_requested_teacher'] = 'Anfrage von Lehrkraft';
$string['admin_requests_unlock_request_until'] = 'bis';
$string['admin_requests_unlock_approve_button'] = 'Zustimmen (1 Tag)';
$string['admin_requests_unlock_prolong_button'] = 'Bearbeitungsfrist + 1 Tag';
$string['admin_requests_unlock_delete_button'] = 'Ablehnen';
$string['admin_requests_unlock_request_created'] = 'die Anfrage wurde erstellt';
$string['admin_requests_no_any'] = 'Keine Benutzeranfragen vorhanden';
