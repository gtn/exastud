...
$string['reports_server_notification'] = 'Falls der Bericht nicht ordnungsgemäß generiert wird, könnte dies auf eine zu große Datenmenge bzw. eine zu geringe Server-Einstellung hinweisen. Bitte kontaktieren Sie in diesem Fall den Administrator des Servers.';
...
$string['report_setting_current_file'] = 'Aktuelle Vorlage';
...
$string['not_enough_data_for_report'] = 'Für den Schüler/die Schülerin liegen keine Rückmeldungen/Bewertungen im DAKORA Kompetenzraster vor!';
...
$string['periods_incorrect'] = 'Es ist kein Eingabezeitraum ausgewählt, oder es sind mehrere Eingabezeiträume aktiviert!';
...
$string['already_marked'] = 'Diese Klasse ist bereits zum Löschen vermerkt';
...
$string['class_marked_as_todelete'] = 'Diese Klasse ist zum Löschen durch den Administrator markiert.';
...
// === events ===
$string['event_classcreated_name'] = 'Die Klasse wurde erstellt';
$string['event_classdeleted_name'] = 'Die Klasse wurde gelöscht';
$string['event_classupdated_name'] = 'Die Klasse wurde aktualisiert';
$string['event_classmemberassigned_name'] = 'Der Benutzer wurde der Klasse hinzugefügt';
$string['event_classmemberunassigned_name'] = 'Der Benutzer wurde aus der Klasse entfernt';
$string['event_classteacherassigned_name'] = 'Der Lehrer wurde der Klasse hinzugefügt';
$string['event_classteacherunassigned_name'] = 'Der Lehrer wurde aus der Klasse entfernt';
$string['event_classdatachanged_name'] = 'Die Daten der Klasse wurden geändert';
$string['event_studentdatachanged_name'] = 'Die Schülerdaten wurden geändert';
$string['event_subjectstudentdatachanged_name'] = 'Die Schülerdaten für das Fach wurden geändert';
$string['event_classassessmentcategory_added_name'] = 'Die Beurteilungskategorie wurde der Klasse angefügt';
$string['event_classassessmentcategory_deleted_name'] = 'Die Beurteilungskategorie wurde bei der Klasse entfernt';
$string['event_periodcreated_name'] = 'Der Eingabezeitraum wurde erstellt';
$string['event_perioddeleted_name'] = 'Der Eingabezeitraum wurde gelöscht';
$string['event_periodupdated_name'] = 'Der Eingabezeitraum wurde aktualisiert';
$string['event_competencecreated_name'] = 'Die Kompetenz wurde erstellt';
$string['event_competenceupdated_name'] = 'Die Kompetenz wurde aktualisiert';
$string['event_competencedeleted_name'] = 'Die Kompetenz wurde gelöscht';
$string['event_gradingoptioncreated_name'] = 'Die Beurteilungsoption wurde erstellt';
$string['event_gradingoptionupdated_name'] = 'Die Beurteilungsoption  wurde aktualisiert';
$string['event_gradingoptiondeleted_name'] = 'Die Beurteilungsoption  wurde gelöscht';
$string['event_educationplancreated_name'] = 'Der Bildungsplan wurde erstellt';
$string['event_educationplanupdated_name'] = 'Der Bildungsplan wurde aktualisiert';
$string['event_educationplandeleted_name'] = 'Der Bildungsplan wurde gelöscht';
$string['event_subjectcreated_name'] = 'Das Fach wurde erstellt';
$string['event_subjectupdated_name'] = 'Das Fach wurde aktualisiert';
$string['event_subjectdeleted_name'] = 'Das Fach wurde gelöscht';
$string['event_studenthidden_name'] = 'Das Fach wurde ausgeblendet';
$string['event_studentshown_name'] = 'Der Schüler wurde angezeigt';
$string['event_studentreviewcategorychanged_name'] = 'Die Schülerkategorie wurde geändert';
$string['event_studentreviewchanged_name'] = 'Die Schülerbeurteilung wurde geändert';
$string['event_classownerupdated_name'] = 'Der Klassenlehrer wurde aktualisiert';
$string['template_textarea_limits_error'] = 'Bitte Eingabelimits für die Eingabefelder beachten!';
...
$string['learn_and_sociale_for_head'] = 'Lern- und Sozialverhalten: Formulierungsvorschlag für Klassenlehrkraft';
...
//    'relevant Subject'
//],
$string['subject_category_b'] = 'beste Note von "Fächer"';
$string['filter_fieldset'] = 'Filter';
$string['filter_search'] = 'Titel Suche';
$string['filter_bp'] = 'BP';
$string['filter_empty'] = 'keine';
$string['filter_category'] = 'Kategorie';
$string['filter_button'] = 'Filter';
$string['clear_filter'] = 'Clear filters';
$string['not_found_report'] = 'Es wurde kein Bericht gefunden';
$string['filter_show_fulltable'] = 'Ganze Tabelle anzeigen';
...
$string['groupleader_fieldtitle'] = 'Lerngruppenbegleiter';
$string['auditleader_fieldtitle'] = 'Vorsitzender des Prüfungsausschusses';
$string['classleader_fieldtitle'] = 'Klassenlehrer';
