...
$string['new_head_teacher'] = 'new Heads of a class';
...
$string['report_settings_setting_assessmentproject'] = 'Project assessment';
...
$string['settings_only_learnsoziale'] = 'use only learning and social behavior';
$string['settings_shoolname'] = 'Learning Development Report: School Name';
$string['settings_city'] = 'Learning Development Report: City';
$string['settings_edustandarts'] = 'Education standarts';
$string['settings_edustandarts_description'] = 'comma seperated list';
$string['settings_bw_reports'] = 'Baden-Württemberg reports';
$string['settings_exacomp_verbeval'] = 'Exabis competences grid verbalise evaluation';
...
$string['grade_and_difflevel'] = 'Grad and Difficulty level';
$string['de:Eingaben von der letzten Periode/Halbjahr übernehmen'] = 'load last period:';
...
$string['settings_competence_evaltype'] = 'Competence evaluation type exastud';
