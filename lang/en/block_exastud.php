...
$string['attantion_plan_will_change'] = 'Please note: If the education plan is changed, all ratings must be re-entered';
$string['attantion_template_will_change'] = 'Please note: Changing the standard certificate form will change the certificate form for all students.';
