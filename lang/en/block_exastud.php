...
$string['class'] = 'Class';
$string['class_title_for_report'] = 'Classname in Report';
...
$string['report_export_update_reports'] = 'Update reports if exist';
$string['report_export_update_files'] = 'Update files if exist';
...
$string['report_settings_upload_new_filetemplate_overwrite'] = 'Overwrite file if exists';
...
$string['settings_bw_reports'] = 'Community schools templates for reports';
...
$string['classteacher_grade_interdisciplinary_competences'] = 'Class teacher can edit cross-competences';
$string['subjectteacher_grade_interdisciplinary_competences'] = 'Subject teacher can edit cross-competences';
...
$string['class_settings_can_edit_crosscompetencies'] = 'can cross-competences edit:';
$string['class_settings_can_edit_learnsocial'] = 'can Learning and social edit:';
...
$string['cross_competences_for_head'] = 'Cross competences';
...
$string['textarea_linestomuch'] = 'lines to much';
$string['textarea_charstomuch'] = 'chars to much';
...
$string['mixed_bw_nonbw_class_error_2'] = 'Template for class not found. Probably you want to use class for active "exastud | bw_active"';
...
$string['report_settings_userdata_wrong_user_parameter_in_reports_list'] = 'This report has wrong userdata marker. Please edit this report to resolve this error.';
