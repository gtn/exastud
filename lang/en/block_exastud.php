...
$string['class'] = 'Class';
$string['class_educationplan'] = 'Education plan';
...
$string['explainclassname'] = 'Here to edit the class name';
...
$string['report_settings_setting_additional_params'] = 'Additional params';
...
$string['settings_edustandarts'] = 'Educational standards';
$string['settings_edustandarts_description'] = 'comma seperated list';
$string['settings_bw_reports'] = 'Baden-Württemberg templates for reports';
...
$string['competencies'] = 'Competences';
$string['Note'] = 'Grade';
$string['Niveau'] = 'Level';
...
$string['suggestions_from_exacomp'] = 'Suggestions from Exacomp';
...
$string['backup_class_protection'] = 'Passwort protection for class backups';
...
$string['report_for_bilingual'] = 'Report for project assessment';
$string['textblock'] = 'Text block';
$string['learn_and_sociale'] = 'Learning and social behavior';
$string['learn_and_sociale_for_head'] = 'Learning and social behavior: for class teacher';
...
$string['leaders'] = 'Involved persons';
$string['schoollieder_fieldtitle'] = 'School director';
$string['groupleader_fieldtitle'] = 'Group head';
$string['auditleader_fieldtitle'] = 'Chairman of the Audit Committee';
$string['classleader_fieldtitle'] = 'Class head';
