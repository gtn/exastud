...
class studentreview_changed extends base {
    /**
     * Init method.
     *
     * @return void
    ...
    protected function init() {
        ...
        $this->data['objecttable'] = 'block_exastudreview';
    }
    ...
    public static function get_name() {
        return get_string('event_studentreviewchanged_name', 'block_exastud');
    }
    ...
    public static function get_objectid_mapping() {
        return array('db' => 'block_exastudreview', 'restore' => 'studentreview');
    }
}
