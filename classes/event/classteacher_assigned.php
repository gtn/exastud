...
class classteacher_assigned extends base {
    /**
     * Init method.
     *
     * @return void
    ...
    protected function init() {
        ...
        $this->data['objecttable'] = 'block_exastudclassteachers';
    }
    ...
    public static function get_name() {
        return get_string('event_classteacherassigned_name', 'block_exastud');
    }
    ...
    public function get_description() {
        ...
        $result = $this->other['whoDid']." assigned a teacher '$relatedusername' (id: $this->relateduserid) ";
        $result .= "to the class '$classtitle' (id: $this->objectid) ";
    ...
    public static function get_objectid_mapping() {
        return array('db' => 'block_exastudclassteachers', 'restore' => 'classteacher');
    }
}
