...
class student_hidden extends base {
    /**
     * Init method.
     *
     * @return void
    ...
    public static function get_name() {
        return get_string('event_studenthidden_name', 'block_exastud');
    }
    ...
    public function get_description() {
        ...
        $result = $this->other['whoDid']." hidden the student '$studentname' (id: $this->relateduserid)";
    ...
    protected function get_legacy_logdata() {
        return(array($this->courseid, 'exastud', 'hide student',
