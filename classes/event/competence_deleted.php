...
class competence_deleted extends base {
    /**
     * Init method.
     *
     * @return void
    ...
    public static function get_name() {
        return get_string('event_competencedeleted_name', 'block_exastud');
    }
    ...
    public function get_description() {
        ...
        return $this->other['whoDid']." deleted the competence '$title' (id: $this->objectid)";
    }
    ...
    protected function get_legacy_logdata() {
        return(array($this->courseid, 'exastud', 'delete competence',
