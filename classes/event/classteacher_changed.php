...
class classteacher_changed extends base {
    /**
     * Init method.
     *
     * @return void
    ...
    public static function get_name() {
        return get_string('event_classteacherchanged_name', 'block_exastud');
    }
    ...
    public function get_description() {
        ...
        $oldrelatedusername = $this->other['oldrelatedusername'];
        $newrelatedusername = $this->other['newrelatedusername'];
