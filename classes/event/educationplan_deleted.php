...
class educationplan_deleted extends base {
    /**
     * Init method.
     *
     * @return void
    ...
    public static function get_name() {
        return get_string('event_educationplandeleted_name', 'block_exastud');
    }
    ...
    public function get_description() {
        ...
        return $this->other['whoDid']." deleted the Education plan '$title' (id: $this->objectid)";
    }
    ...
    protected function get_legacy_logdata() {
        return(array($this->courseid, 'exastud', 'delete education plan',
